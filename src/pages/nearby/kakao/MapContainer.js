      ...
      {index ? (
        ...
        <>
          ...
          >
            ...
            <BottomBtnBox slotManager={slotManager}>
              <SearchBtn
...
const ResultSearchImg = styled.svg`
  color: var(--color-orange);
`;

const ResultBoldTitle = styled.div`
  margin-left: 4px;
...
const ResultNomalTitle = styled.div`
  margin-left: 4px;
