...
export default function CategorySelect({searchCate, setSearchCate}) {
  const 전체 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("전체")}
  ...
  const 패스트푸드 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("패스트푸드")}
  ...
  const 치킨 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("치킨")}
  ...
  const 분식 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("분식")}
  ...
  const 야식 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("야식")}
  ...
  const 한식 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("한식")}
  ...
  const 중식 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("중식")}
  ...
  const 양식 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("양식")}
  ...
  const 일식 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("일식")}
  ...
  const 디저트 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("디저트")}
  ...
  const 채식 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("채식")}
  ...
  const 아시안 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("아시안")}
  ...
  const 건강식 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("건강식")}
  ...
  const 샌드위치 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("샌드위치")}
  ...
  const 편의점 = () => {
    return (
      <SelectST.SelectBox onClick={() => setSearchCate("편의점")}
