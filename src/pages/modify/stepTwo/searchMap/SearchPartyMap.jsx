...
export default function SearchMap({ setIndex, data, setData }) {
  ...
  const saveAddressHandler = () => {
    if (markerInfo.road_address_name === '') {
      const gatherName = markerInfo.place_name;
      const gatherAddress = markerInfo.road_address_name;
      const region = markerInfo.place_name.split(' ')[0];
      setData({
        ...data,
        region: region,
      ...
      const gatherName = markerInfo.place_name;
      const gatherAddress = markerInfo.address_name;
      const region = markerInfo.place_name.split(' ')[0];
      setData({
        ...data,
        region: region,
